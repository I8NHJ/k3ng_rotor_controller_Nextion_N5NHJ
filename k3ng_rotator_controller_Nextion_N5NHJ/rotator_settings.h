...
#define PWM_SPEED_VOLTAGE_X1  32         // 0 to 255
#define PWM_SPEED_VOLTAGE_X2  64        // 0 to 255
#define PWM_SPEED_VOLTAGE_X3  128       // 0 to 255
#define PWM_SPEED_VOLTAGE_X4  255        // 0 to 255

//AZ
#define AZ_SLOWSTART_DEFAULT 1            // 0 = off ; 1 = on
#define AZ_SLOWDOWN_DEFAULT 1             // 0 = off ; 1 = on
#define AZ_SLOW_START_UP_TIME 3000        //N5NHJ=3000 DEFAULT=2000//  // if slow start is enabled, the unit will ramp up speed for this many milliseconds
...
#define LCD_UPDATE_TIME 750 //1000           // LCD update time in milliseconds
#define LCD_HHMM_CLOCK_POSITION LEFT          //LEFT or RIGHT
#define LCD_HHMMSS_CLOCK_POSITION RIGHT          //LEFT or RIGHT
#define LCD_ALT_HHMM_CLOCK_AND_MAIDENHEAD_POSITION CENTER
#define LCD_ALT_HHMM_CLOCK_AND_MAIDENHEAD_ROW 3
...
#define LCD_REDRAW_UPON_COMMANDS 0 //1           // set to 1 to enable screen redraws upon commands and button presses
...
#define LCD_HHMMSS_CLOCK_ROW 3
#define LCD_HHMM_CLOCK_ROW 3
...
#define AZIMUTH_SMOOTHING_FACTOR 30      // N5NHJ value = 0 to 99.9
#define ELEVATION_SMOOTHING_FACTOR 30    // N5NHJ value = 0 to 99.9
...
#define DEFAULT_LATITUDE 33.6    //// 40.889958
#define DEFAULT_LONGITUDE -96.4  ////-75.585972
...
#define ETHERNET_MAC_ADDRESS 0xA8,0x61,0x0A,0xAE,0xE0,0xDA  //<-DON'T FORGET TO USE DIFFERENT MAC ADDRESSES FOR MASTER AND SLAVE!!!
#define ETHERNET_IP_ADDRESS 192,168,1,10  //<-DON'T FORGET TO USE DIFFERENT IP ADDRESSES FOR MASTER AND SLAVE!!!
#define ETHERNET_IP_GATEWAY 192,168,1,254
#define ETHERNET_IP_SUBNET_MASK 255,255,255,0
#define ETHERNET_TCP_PORT_0 23
#define ETHERNET_IP_STRING "192.168.1.10" // N5NHJ a string representation of the IP address
...
#define AUDIBLE_ALERT_TYPE 2 ////1   // 1 = Logic high/low (set AUDIBLE_PIN_ACTIVE_STATE and AUDIBLE_PIN_INACTIVE_STATE below, 2 = tone (set AUDIBLE_PIN_TONE_FREQ below)
#define AUDIBLE_ALERT_DURATION_MS 50
